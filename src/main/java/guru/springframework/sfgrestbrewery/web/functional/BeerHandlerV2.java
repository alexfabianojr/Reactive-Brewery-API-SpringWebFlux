...
public class BeerHandlerV2 {
    ...
    //Nao temos o @Validated do MVC no reactor
    private void validate(BeerDto beerDto) {
        Errors erros = new BeanPropertyBindingResult(beerDto, "beerDto");
    ...
    public Mono<ServerResponse> deleteBeer(ServerRequest request) {
        return beerService
                .reactiveDeleteById(Integer.valueOf(request.pathVariable("beerId")))
